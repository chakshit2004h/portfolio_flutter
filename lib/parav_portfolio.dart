...
class portfolio_4 extends StatefulWidget{
  const portfolio_4({super.key});

  @override
  State<StatefulWidget> createState() {
    return portfolio_4_state();
  }

}
class portfolio_4_state extends State<portfolio_4>{
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Parav's Portfolio",style: TextStyle(color: Colors.white),),
        centerTitle: true,
            ...
            children: [
              const Row(
                children: [
                  const Padding(
                      ...
                      child: CircleAvatar(backgroundImage: AssetImage("assets/images/parav.png"),radius: 90,)
                  ),
                  Column(
                    children: [
                      Padding(
                        padding: EdgeInsets.only(left: 10.0),
                        child: Text("Paravdeep Walia",style: TextStyle(fontSize: 25,color: Colors.white,fontWeight: FontWeight.bold)),
                      ),
              ...
              const Row(
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(top: 30.0,left: 15.0),
                      child: Text("parav2004@gmail.com",style: TextStyle(fontSize: 25,color: Colors.white),),
                    )
                  ]
              ),
              const Row(
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(top: 30.0,left: 15.0),
                      child: Text("9465110566",style: TextStyle(fontSize: 25,color: Colors.white),),
                    )
                  ]
              ),
              Padding(
