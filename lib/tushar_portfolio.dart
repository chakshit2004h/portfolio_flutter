...
class portfolio_3 extends StatefulWidget{
  const portfolio_3({super.key});

  @override
  State<StatefulWidget> createState() {
    return portfolio_3_state();
  }

}
class portfolio_3_state extends State<portfolio_3>{
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Tushar's Portfolio",style: TextStyle(color: Colors.white),),
        centerTitle: true,
            ...
            children: [
              const Row(
                children: [
                  const Padding(
                      ...
                      child: CircleAvatar(backgroundImage: AssetImage("assets/images/tushar.jpg"),radius: 90,)
                  ),
                  Column(
                    children: [
                      Padding(
                        padding: EdgeInsets.only(left: 10.0),
                        child: Text("Tushar Pareenja",style: TextStyle(fontSize: 25,color: Colors.white,fontWeight: FontWeight.bold)),
                      ),
              ...
              const Row(
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(top: 30.0,left: 15.0),
                      child: Text("xyz2004@gmail.com",style: TextStyle(fontSize: 25,color: Colors.white),),
                    )
                  ]
              ),
              const Row(
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(top: 30.0,left: 15.0),
                      child: Text("8930594554",style: TextStyle(fontSize: 25,color: Colors.white),),
                    )
                  ]
              ),
              Padding(
